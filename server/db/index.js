...
const seed = async()=> {
  ...
  const [foo, bar, bazz] = await Promise.all([
    ...
    createProduct({ name: 'Spidermans Web Shooters', price:3000, description:'This is Spiderman\'s web gadget used on his wrist. Each purchase comes with 10 reloads of premade web fluid.', quantity: 4, image_url: 'https://i.pinimg.com/550x/a4/29/d3/a429d3d5410d417ae86b38c2d1af5e79.jpg' }),
