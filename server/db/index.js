...
const seed = async()=> {
  ...
  const [foo, bar, bazz] = await Promise.all([
    createProduct({ name: 'The Batmobile', price:100000000, description:'The infamous mode of transportation for one of the most prestigious heroes in Gotham, Batman!', quantity: 1, image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmfDSHF5eotCiwTQbfT981MuXDn5G66tiT3TfPNU-F2iGizWRproABlsU16ygzkeDCMHs&usqp=CAU', for_vip: true, is_weapon: false, is_unique: true, is_accessory: false, is_material: false, is_suit: false, is_substance: false, is_vehicle: true}),

    createProduct({ name: 'The Lasso of Truth', price:265000, description:'A weapon wielded by none other than Wonder Woman herself!', quantity: 1, image_url: 'https://www.therpf.com/forums/attachments/lasso-jpg.1332542/', for_vip: true, is_weapon: true, is_unique: true, is_accessory: false, is_material: false, is_suit: false, is_substance: false, is_vehicle: false }),
    ...
    createProduct({ name: 'Spidermans Web Shooters', price:3000, description:'This is spiderman\'s web gadget used on his wrist. Each purchase comes with 10 reloads of premade web fluid.', quantity: 4, image_url: 'https://i.pinimg.com/550x/a4/29/d3/a429d3d5410d417ae86b38c2d1af5e79.jpg', for_vip: false, is_weapon: false, is_unique: true, is_accessory: true, is_material: false, is_suit: false, is_substance: false, is_vehicle: false }),

    createProduct({ name: 'Thors Hammer', price:100, description:'Our cheapest item. We can provide you the coordinates once paid. Delivery is not an option because none of the team members are worthy. Good luck trying to pick this up yourself.', quantity: 1, image_url: 'https://media.printables.com/media/prints/292790/images/2572161_3c320593-2113-4ace-9767-47d31f0ef12d/thumbs/cover/1200x630/jpg/img_5334.jpg', for_vip: false, is_weapon: true, is_unique: true, is_accessory: false, is_material: false, is_suit: false, is_substance: false, is_vehicle: false }),
    ...
    createProduct({ name: 'Vibranium', price:100000000, description:'A piece of the very rare metal Vibranium.', quantity: 1, image_url: 'https://static.wikia.nocookie.net/marvelcinematicuniverse/images/1/17/Vibranium_in_Hand.jpg', for_vip: true, is_weapon: false, is_unique: false, is_accessory: false, is_material: true, is_suit: false, is_substance: true, is_vehicle: false }),

    createProduct({ name: 'Starlord\'s Old Helmet', price:25000000, description:'An old school helmet from the legend himself. Best as a collector\'s item.', quantity: 1, image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQABVztO4uhES5RcH9-FUyfwganskdzw6Ff5A&usqp=CAU', for_vip: false, is_weapon: false, is_unique: true, is_accessory: true, is_material: false, is_suit: false, is_substance: false, is_vehicle: false }),
    ...
    createProduct({ name: 'Raphael\'s Sai', price:5000, description:'The Teenage Mutant Ninja Turtle, Raphael\'s Sai\'s!', quantity: 2, image_url: 'https://static.wikia.nocookie.net/tmnt/images/c/ca/Sai.jpg', for_vip: false, is_weapon: true, is_unique: true, is_accessory: false, is_material: false, is_suit: false, is_substance: false, is_vehicle: false }),

    createProduct({ name: 'Scorption\s Kunai', price:7, description:'Straight from one of Scorpion\'s frosty opponents.', quantity: 1, image_url: 'https://cdna.artstation.com/p/assets/images/images/038/430/292/4k/eric-newgard-img-0970-small.jpg?1623082656', for_vip: false, is_weapon: true, is_unique: true, is_accessory: false, is_material: false, is_suit: false, is_substance: false, is_vehicle: false }),
